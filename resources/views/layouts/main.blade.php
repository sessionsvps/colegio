            ...
            <ul class="space-y-2 font-medium">
                ...
                {{-- <li>
                    <a href="#"
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                ...
                {{-- <li>
                    <a href="{{route('v4')}}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Alumno, Docente y Admin</span>
                    </a>
                </li> --}}
                <li>
                ...
                {{-- <li>
                    <a href="{{route('v6')}}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Docente y Alumno</span>
                    </a>
                </li> --}}
                {{-- <li>
                    <a href="#"
