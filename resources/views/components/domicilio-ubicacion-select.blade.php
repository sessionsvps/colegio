<div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
    ...
    <select
        ...
        @foreach($departamentos as $departamento)
            <option value="{{ $departamento->id }}" {{ $entidad->domicilio->departamento == $departamento->id ? 'selected' : '' }}>{{ $departamento->nombre }}</option>
        @endforeach
    </select>
        ...
        $('#{{ $departamentoName }}').on('change', function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let oldProvincia = '{{ $entidad->domicilio->provincia }}';
        ...
        $('#{{ $provinciaName }}').on('change', function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let oldDistrito = '{{ $entidad->domicilio->distrito }}'
                    $.each(response, function(index, value){
