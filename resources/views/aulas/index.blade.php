    ...
    <div>
        ...
        @if (Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Secretaria') || Auth::user()->hasRole('Director'))
            <form method="GET" action="{{ route('aulas.index') }}" class="mb-6">
                <div class="mt-5 md:mt-10 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 lg:gap-4">
                    <div class="">
        ...
        <input class="hidden" type="text" id="año_escolar" name="año_escolar" value="{{ request('año_escolar') }}"
            readonly>
