...
<div>
    ...
    <form method="POST" action="{{ route('docentes.update',$docente->codigo_docente) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- Datos del Docente -->
        <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6 grid md:grid-cols-2 gap-5 lg:grid-rows-5">
                ...
                <div class="md:col-span-2 lg:col-span-1 lg:row-span-5">
                    ...
                    <div class="flex flex-col items-center border border-gray-300 rounded-lg p-4">
                        <img id="photoPreview" src="{{ $docente->user->profile_photo_url }}"
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3 mb-0">
                    ...
                    <input
                        ...
                        readonly value="{{ old('fecha_ingreso', $docente->fecha_ingreso) }}">
                    @error('fecha_ingreso')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3 mb-6 lg:mb-0">
                    ...
                    <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="nacionalidad" id="nacionalidad" onchange="ocultar()">
                        <option value="Peruano(a)" {{ $docente->nacionalidad == 'Peruano(a)' ? 'selected' : '' }} >Peruano(a)</option>
                        <option value="Extranjero(a)" {{ $docente->nacionalidad == 'Extranjero(a)' ? 'selected' : '' }} >Extranjero(a)</option>
                    </select>
                    @error('nacionalidad')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
            ...
            <div id="datos-geograficos" class="flex flex-wrap -mx-3 mb-6">
                <x-edit-ubicacion-select :entidad="$docente" :departamento-name="'departamento'" :provincia-name="'provincia'" :distrito-name="'distrito'"/>
            </div>
        </div>
        ...
        <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <x-domicilio-ubicacion-select :entidad="$docente" :departamento-name="'departamento_d'" :provincia-name="'provincia_d'" :distrito-name="'distrito_d'"/>
            </div>
        </div>
