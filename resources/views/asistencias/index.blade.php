...
@section('contenido')
    <div class="container mx-auto">
        ...
        <p class="font-bold text-xl lg:text-2xl">Inasistencias y Tardanzas</p>
        <form action="{{ route('asistencias.index') }}" method="GET">
            <div class="mt-5 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="col-span-3 md:col-span-1" id="botonBuscar">
                    <button type="submit"
        ...
        <div class="mt-20 bg-white shadow-lg p-6 rounded-lg">
