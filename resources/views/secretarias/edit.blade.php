...
<div>
    ...
    <h2 class="text-xl font-bold mb-4">Editar Secretaria</h2>
    ...
    <form method="POST" action="{{ route('secretarias.update',$secretaria->codigo_secretaria) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6 grid md:grid-cols-2 gap-5 lg:grid-rows-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="mb-4 md:mr-5 lg:mb-0">
                            ...
                            <input
                                ...
                                id="dni" name="dni" type="text" placeholder="DNI" value="{{ old('dni', $secretaria->dni) }}"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('fecha_nacimiento', $secretaria->fecha_nacimiento) }}" readonly>
                ...
                <div class="md:col-span-2 lg:col-span-1 lg:row-span-5">
                    ...
                    <div class="flex flex-col items-center border border-gray-300 rounded-lg p-4">
                        <img id="photoPreview" src="{{ $secretaria->user->profile_photo_url }}"
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('primer_nombre', $secretaria->primer_nombre) }}" readonly>
                    @error('primer_nombre')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="lg:row-start-3">
                    ...
                    <input
                        ...
                        value="{{ old('otros_nombres', $secretaria->otros_nombres) }}" readonly>
                    @error('otros_nombres')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="lg:row-start-4">
                    ...
                    <input
                        ...
                        value="{{ old('apellido_paterno', $secretaria->apellido_paterno) }}" readonly>
                ...
                <div class="lg:row-start-5">
                    ...
                    <input
                        ...
                        value="{{ old('apellido_materno', $secretaria->apellido_materno) }}" readonly>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        value="{{ old('sexo', $secretaria->sexo == 1 ? 'Masculino' : 'Femenino') }}" readonly>
                    <input id="sexo" name="sexo" type="hidden" value="{{ old('sexo', $secretaria->sexo) }}">
                    @error('sexo')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full md:w-1/2 px-3 mb-0">
                    ...
                    <input
                        ...
                        readonly value="{{ old('fecha_ingreso', $secretaria->fecha_ingreso) }}">
                    @error('fecha_ingreso')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="email" name="email" type="email" placeholder="Correo" value="{{ old('email', $secretaria->email) }}">
                    @error('email')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div> 
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        value="{{ old('telefono_celular', $secretaria->telefono_celular) }}" maxlength="9">
                ...
                <div class="w-full md:w-1/3 px-3 mb-0">
                    ...
                    <select
                        ...
                        <option value="{{ $estado->id_estado }}" {{ old('id_estado', $secretaria->id_estado) == $estado->id_estado ?
                            'selected' : '' }}>
                            {{ $estado->detalle }}
                        </option>
                        @endforeach
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3 mb-6 lg:mb-0">
                    ...
                    <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="nacionalidad" id="nacionalidad" onchange="ocultar()">
                        <option value="Peruano(a)" {{ $secretaria->nacionalidad == 'Peruano(a)' ? 'selected' : '' }} >Peruano(a)</option>
                        <option value="Extranjero(a)" {{ $secretaria->nacionalidad == 'Extranjero(a)' ? 'selected' : '' }} >Extranjero(a)</option>
                    </select>
                    @error('nacionalidad')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
        ...
        <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="direccion" name="direccion" type="text" placeholder="Dirección" value="{{ old('direccion', $secretaria->user->domicilio->direccion) }}">
                    @error('direccion')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full md:w-1/3 px-3 mb-0">
                    ...
                    <input
                        ...
                        value="{{ old('telefono_fijo', $secretaria->user->domicilio->telefono_fijo) }}">
                    @error('telefono_fijo')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
