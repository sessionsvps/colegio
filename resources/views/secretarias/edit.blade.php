...
<div>
    ...
    <form method="POST" action="{{ route('secretarias.update',$secretaria->codigo_secretaria) }}">
        @csrf
        @method('PUT')
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="dni" name="dni" type="text" placeholder="DNI" value="{{ old('dni', $secretaria->dni) }}" maxlength="8"
