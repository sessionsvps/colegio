                ...
                <tr
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex justify-center">
                            <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Ver
                                Info</a>
                        </div>
                    </td>
                </tr>
            ...
            <form id="filter-form" action="{{ route('cursos.info', $curso->codigo_curso) }}" method="GET"
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-3 lg:mb-0">
                    ...
                    <select
                        ...
                        <option value="{{ $docente->codigo_docente }}" {{ request('docente')==$docente->codigo_docente ?
                            'selected' : '' }}>
            ...
            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            {{ $info_estudiante->estudiante->primer_nombre . ' ' .
                            $info_estudiante->estudiante->otros_nombres .
                            ' ' .
