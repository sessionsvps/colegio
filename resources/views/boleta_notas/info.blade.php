...
@section('contenido')
    <div class="flex flex-col md:flex-row md:items-center justify-between">
        ...
        @if(Auth::user()->hasRole('Secretaria') || Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Director'))
            <div class="mt-5 md:mt-0 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            reporteSelect.addEventListener('change', function () {
                ...
                if (selectedValue == '1') { // EXCEL
                    ...
                    generateReportButton.href = "{{ route('exportPdfNotas', ['codigo_estudiante' => '__codigo_estudiante__','año_escolar' => $estudiante->año_escolar]) }}".replace('__codigo_estudiante__', codigoEstudiante);
                }
            });
        });
    </script>
