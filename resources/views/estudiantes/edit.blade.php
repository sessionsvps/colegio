...
<div>
    ...
    @endif
    <form method="POST" action="{{ route('estudiantes.update', $estudiante->codigo_estudiante) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6 grid md:grid-cols-2 gap-5 lg:grid-rows-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('fecha_nacimiento', $estudiante->fecha_nacimiento) }}" readonly>
                ...
                <div class="md:col-span-2 lg:col-span-1 lg:row-span-5">
                    ...
                    <div class="flex flex-col items-center border border-gray-300 rounded-lg p-4"> 
                        <img id="photoPreview" src="{{ $estudiante->user->profile_photo_url }}"
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('primer_nombre', $estudiante->primer_nombre) }}" readonly>
                    @error('primer_nombre')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="lg:row-start-3">
                    ...
                    <input
                        ...
                        value="{{ old('otros_nombres', $estudiante->otros_nombres) }}" readonly>
                    @error('otros_nombres')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="lg:row-start-4">
                    ...
                    <input
                        ...
                        value="{{ old('apellido_paterno', $estudiante->apellido_paterno) }}" readonly>
                ...
                <div class="lg:row-start-5">
                    ...
                    <input
                        ...
                        value="{{ old('apellido_materno', $estudiante->apellido_materno) }}" readonly>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="sexo_texto" name="sexo_texto" type="text" value="{{ old('sexo', $estudiante->sexo == 1 ? 'Masculino' : 'Femenino') }}" readonly>
                    <input id="sexo" name="sexo" type="hidden" value="{{ old('sexo', $estudiante->sexo) }}">
                    @error('sexo')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full md:w-1/2 px-3 mb-0">
                    ...
                    <input
                        ...
                        readonly value="{{ old('año_ingreso', $estudiante->año_ingreso) }}">
                    @error('año_ingreso')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
